defmodule ValueFormattersTest do
  ...
  @opts [cldr: ValueFormatters.Cldr]
  ...
  describe "numbers" do
    test "format float with units and precision" do
      ...
      assert ValueFormatters.to_string(1.234, format_definition, @opts) == {:ok, "1.23 kg"}

      assert ValueFormatters.to_string(12.345678912345679983731293, format_definition, @opts) ==
               {:ok, "12.35 kg"}
    end
    ...
    test "format float with precision" do
      ...
      assert ValueFormatters.to_string(1.234, format_definition, @opts) == {:ok, "1.23"}
    end
    ...
    test "format float with units" do
      ...
      assert ValueFormatters.to_string(1.234, format_definition, @opts) == {:ok, "1.234 kg"}
    end
    ...
    test "format float without units and precision" do
      ...
      assert ValueFormatters.to_string(1.234, format_definition, @opts) == {:ok, "1.234"}
    end
    ...
    test "no changes to float" do
      assert ValueFormatters.to_string(1.234, nil, @opts) == {:ok, "1.234"}
    end

    # Locale en
    test "format float using locale" do
      assert ValueFormatters.to_string(1_000.234, nil, @opts) == {:ok, "1,000.234"}
    end

    test "unchanged float inferred as a string" do
      assert ValueFormatters.to_string("1000.234", nil, @opts) == {:ok, "1000.234"}
    end
    ...
    test "format integer with units" do
      ...
      assert ValueFormatters.to_string(1, format_definition, @opts) == {:ok, "1 kg"}
    end

    test "format integer with german locale in opts" do
      assert ValueFormatters.to_string(1_000, nil, Keyword.merge(@opts, locale: "de")) ==
               {:ok, "1.000"}
    end
    ...
    test "format integer with german locale in the process" do
      ...
      assert ValueFormatters.to_string(1_000, nil, @opts) ==
               {:ok, "1.000"}
    end
  end
  ...
  describe "dates" do
    test "date only (short)" do
      ...
      assert ValueFormatters.to_string(~U[2016-10-24 13:26:08.003Z], date_definition, @opts) ==
               {:ok, "10/24/16"}
    end
    ...
    test "date short date" do
      ...
      assert ValueFormatters.to_string(~D[2016-10-24], date_definition, @opts) ==
               {:ok, "10/24/16"}
    end
    ...
    test "date from iso8601" do
      ...
      assert ValueFormatters.to_string("2016-10-24T15:22:24Z", date_definition, @opts) ==
               {:ok, "Oct 24, 2016"}

      # Assert that date-only string is accepted
      assert ValueFormatters.to_string("2016-10-24", date_definition, @opts) ==
               {:ok, "Oct 24, 2016"}
    end
    ...
    test "datetime from unix timestamp" do
      ...
      assert ValueFormatters.to_string(1_477_323_744, date_definition, @opts) ==
    ...
    test "date shorthand" do
      assert ValueFormatters.to_string(~D[2016-10-24], "date", @opts) == {:ok, "Oct 24, 2016"}
    end

    test "datetime shorthand" do
      assert ValueFormatters.to_string(~U[2016-10-24 13:26:08.003Z], "date", @opts) ==
               {:ok, "Oct 24, 2016, 1:26:08 PM"}
    end

    test "time shorthand" do
      assert ValueFormatters.to_string(~T[13:26:08.003], "date", @opts) == {:ok, "1:26:08 PM"}
    end
  end
  ...
  describe "date_relative" do
    test "works with shorthand description" do
      assert ValueFormatters.to_string(DateTime.utc_now(), "date_relative", @opts) == {:ok, "now"}
    end
    ...
    test "yesterday" do
      ...
      assert ValueFormatters.to_string(yesterday, "date_relative", @opts) == {:ok, "yesterday"}
    end
    ...
    test "tomorrow" do
      ...
      assert ValueFormatters.to_string(tomorrow, "date_relative", @opts) == {:ok, "tomorrow"}
    end
    ...
    test "5 days ago" do
      ...
      assert ValueFormatters.to_string(past, "date_relative", @opts) == {:ok, "5 days ago"}
    end
    ...
    test "in 5 days" do
      ...
      assert ValueFormatters.to_string(future, "date_relative", @opts) == {:ok, "in 5 days"}
    end
    ...
    test "12 months ago" do
      ...
      assert ValueFormatters.to_string(past, "date_relative", @opts) == {:ok, "12 months ago"}
    end
    ...
    test "last year" do
      ...
      assert ValueFormatters.to_string(past, "date_relative", @opts) == {:ok, "last year"}
    end
    ...
    test "last week" do
      ...
      assert ValueFormatters.to_string(past, "date_relative", @opts) == {:ok, "last week"}
    end
    ...
    test "5 years ago" do
      ...
      assert ValueFormatters.to_string(past, "date_relative", @opts) == {:ok, "5 years ago"}
    end
    ...
    test "date in iso8601" do
      ...
      assert ValueFormatters.to_string(date_iso, "date_relative", @opts) == {:ok, "5 years ago"}
    end
  ...
  describe "date_iso" do
    test "datetime in iso8601" do
      ...
      assert ValueFormatters.to_string(~U[2016-10-24 13:26:08Z], date_definition, @opts) ==
    ...
    test "time in iso8601" do
      ...
      assert ValueFormatters.to_string(~T[13:26:08.003], date_definition, @opts) ==
               {:ok, "13:26:08.003"}
    end
    ...
    test "from iso string" do
      ...
      assert ValueFormatters.to_string("2016-10-24T13:26:08Z", date_definition, @opts) ==
               {:ok, "2016-10-24T13:26:08Z"}
    end
    ...
    test "from unix timestamp" do
      ...
      assert ValueFormatters.to_string(1_477_323_744_000, date_definition, @opts) ==
  ...
  describe "coordinates" do
    ...
    test "inference object no radius" do
      assert ValueFormatters.to_string(%{"lat" => 43.1298, "lng" => 54.1234}, %{}, @opts) ==
               {:ok, "43.1298°, 54.1234°"}
    end

    test "inference list with radius" do
      assert ValueFormatters.to_string([123.1345, 34.123, 2], %{}, @opts) ==
               {:ok, "123.1345°, 34.123°, 2 m"}
    end
